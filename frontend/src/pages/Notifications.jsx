...
import { getMyNotifications, markNotifRead, markAllNotifsRead, deleteNotif } from '../api/notifications';
...
export default function Notifications() {
  ...
  return (
    <main className="notif-page container">
      <div className="notif-page__header">
        <h1><Bell size={22} /> Notifications {unread > 0 && <span className="notif-page__badge">{unread} new</span>}</h1>
        {unread > 0 && (
      ...
      {loading && notifs.length === 0 && <div className="empty-state"><p>Loading…</p></div>}
